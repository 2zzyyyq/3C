...
*\*\param   NVIC_InitStruct (The input parameters must be the following values) :
*\*\              - NVIC_IRQChannel :
*\*\                   -  IRQn_Type    N32G033 Interrupt Number Definition
...
*\*\param SysTick_CLKSource (The input parameters must be the following values) :
