...
**/
#ifndef __N32G033_HDIV_H__
#define __N32G033_HDIV_H__
...
/* HDIV bus hold */
#define HDIV_BUSHOLDEN  (HDIV_CTRLSTS_HDIVBUSHOLD)

/* auto start of HDIV calculating */
#define HDIV_AUTOSTARTCAL  (HDIV_CTRLSTS_HDIVAUTOSTART)

/* calculated number is signed or unsigned */
#define HDIV_SIGNDATAEN  (HDIV_CTRLSTS_HDIVTYPESEL)

/* HDIVSTART */
#define HDIV_START_ENABLE  (HDIV_CTRLSTS_HDIVSTART)

/* HDIV_Flag */
#define HDIV_FLAG_DF      ((uint32_t)HDIV_CTRLSTS_HDIVDF)
#define HDIV_FLAG_DIVBY0  ((uint32_t)HDIV_DIVBY0_DIVBY0)


/** HDIV_Exported_Functions **/
