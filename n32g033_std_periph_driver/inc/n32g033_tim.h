...
#ifndef __N32G033_TIM_H
#define __N32G033_TIM_H
...
typedef struct
{
    ...
    uint32_t RepetCnt;           /* Specifies the repetition counter value. Each time the REPCNT downcounter
    ...
    uint32_t EtrOrClr;          /* ETR or COMP can be selected as ETRF source */
...
typedef struct
{
    ...
    uint32_t OutputNState;           /* Specifies the TIM complementary Output Compare state.
                                                             ...
                                                             This parameter is valid for ATIM. */
...
typedef struct
{
    ...
    uint32_t Prescaler;         /* Specifies the prescaler value of filter, the range is [0, 1F] */
...
#define TIM_CAPCH1SEL_IOM                  (TIM_REG_BIT_MASK) 
#define TIM_CAPCH1SEL_COMP                 (TIM_CTRL1_C1SEL) 

#define TIM_ETRSEL                         (TIM_REG_BIT_MASK) 
#define TIM_COMPSEL                        (TIM_CTRL1_CLRSEL) 
...
#define TIM_TRIG_SEL_IN_TR3                (TIM_SMCTRL_TSEL_0 | TIM_SMCTRL_TSEL_1) 
...
#define TIM_CH_7                           ((uint32_t)0x00000016)
...
#define TIM_BREAK_IOM1                      (TIM_AF1_IOM1BRKEN)
#define TIM_BREAK_COMP1                     (TIM_AF1_COMP1BRKEN)
#define TIM_BREAK_IOM2                      (TIM_AF1_IOM2BRKEN)
#define TIM_BREAK_IOM3                      (TIM_AF1_IOM3BRKEN)
#define TIM_BREAK_IOM4                      (TIM_AF1_IOM4BRKEN)

/** System break input **/
#define IS_SYS_BREAK(SOURCE)                (((SOURCE) == TIM_BREAK_LOCKUP)  || \
                                             ((SOURCE) == TIM_BREAK_PVD))

 /** Polarity of break input **/
#define TIM_BREAK_IOM1P                      (TIM_AF1_IOM1BRKP)
#define TIM_BREAK_COMP1P                     (TIM_AF1_COMP1BRKP)
#define TIM_BREAK_IOM2P                      (TIM_AF1_IOM2BRKP)
#define TIM_BREAK_IOM3P                      (TIM_AF1_IOM3BRKP)
#define TIM_BREAK_IOM4P                      (TIM_AF1_IOM4BRKP)
#define TIM_BREAK_IOM1_POLARITY_INVERT       (0x00000001U)
#define TIM_BREAK_IOM2_POLARITY_NONINVERT    (0x00000000U)
...
#define TIM_INT_C3LDCNT                     (TIM_DINTEN_C3LDCNTIEN)
...
#define TIM_DMABASE_ENCDAT                  (TIM_DCTRL_DBADDR_1 | TIM_DCTRL_DBADDR_5)
#define TIM_DMABASE_ENCMCTRL                (TIM_DCTRL_DBADDR_0 | TIM_DCTRL_DBADDR_1 | TIM_DCTRL_DBADDR_5)
#define TIM_DMABASE_ENCLVR                  (TIM_DCTRL_DBADDR_2 | TIM_DCTRL_DBADDR_5)
...
#define TIM_DMABURST_LENGTH_36TRANSFERS     (TIM_DCTRL_DBLEN_0 | TIM_DCTRL_DBLEN_1 | TIM_DCTRL_DBLEN_5)
#define TIM_DMABURST_LENGTH_37TRANSFERS     (TIM_DCTRL_DBLEN_2 | TIM_DCTRL_DBLEN_5)
...
/** TIM_Encoder2Mode **/
#define TIM_ENCODE2_QUA_MODE_TI1             (TIM_ENCMCTRL_ENCMD_0)    
#define TIM_ENCODE2_QUA_MODE_TI2             (TIM_ENCMCTRL_ENCMD_1)
#define TIM_ENCODE2_QUA_MODE_TI12            (TIM_ENCMCTRL_ENCMD_0 | TIM_ENCMCTRL_ENCMD_1)
#define TIM_ENCODE2_QUA_MODE_SINGLE_TI1      (TIM_ENCMCTRL_ENCMD_2)
#define TIM_ENCODE2_QUA_MODE_SINGLE_TI2      (TIM_ENCMCTRL_ENCMD_0 | TIM_ENCMCTRL_ENCMD_2)
#define TIM_ENCODE2_DUL_CLKPLUS_MODE1        (TIM_ENCMCTRL_ENCMD_1 | TIM_ENCMCTRL_ENCMD_3)
#define TIM_ENCODE2_DUL_CLKPLUS_MODE2        (TIM_ENCMCTRL_ENCMD_0 | TIM_ENCMCTRL_ENCMD_1 | TIM_ENCMCTRL_ENCMD_3)    
#define TIM_ENCODE2_SINGLE_CLKPLUS_MODE1     (TIM_ENCMCTRL_ENCMD_1 | TIM_ENCMCTRL_ENCMD_2)
#define TIM_ENCODE2_SINGLE_CLKPLUS_MODE2     (TIM_ENCMCTRL_ENCMD_0 | TIM_ENCMCTRL_ENCMD_1 | TIM_ENCMCTRL_ENCMD_2) 
#define TIM_ENCODE2_CCW_MODE1                (TIM_ENCMCTRL_ENCMD_3) 
#define TIM_ENCODE2_CCW_MODE2                (TIM_ENCMCTRL_ENCMD_0 | TIM_ENCMCTRL_ENCMD_3)
...
#define TIM_TRGO_SRC_OC5REF                 (TIM_CTRL2_MMSEL_0 | TIM_CTRL2_MMSEL_3)
#define TIM_TRGO_SRC_OC6REF                 (TIM_CTRL2_MMSEL_1 | TIM_CTRL2_MMSEL_3)
#define TIM_TRGO_SRC_OC7REF                 (TIM_CTRL2_MMSEL_0 | TIM_CTRL2_MMSEL_1 | TIM_CTRL2_MMSEL_3)
...
#define TIM_CC7EN                           (TIM_CCEN_CC7EN)
...
#define TIM_FLAG_LBKP                       (TIM_STS_LBKPITF)
#define TIM_FLAG_PBKP                       (TIM_STS_PBKITF)
#define TIM_FLAG_COMP                       (TIM_STS_COMPBITF)
#define TIM_FLAG_IOM                        (TIM_STS_IOMBITF)
#define TIM_FLAG_C3LDCNT                    (TIM_STS_C3LDCNTITF)

/** TIM_CH3_Trgi_LVR_Polarity **/
#define TIM_CH3_POLARITY_HIGH               (TIM_REG_BIT_MASK)
#define TIM_CH3_POLARITY_LOW                (TIM_ENCMCTRL_C3LDCNTSEL_0)
#define TIM_CH3_POLARITY_RISING             (TIM_ENCMCTRL_C3LDCNTSEL_1)
#define TIM_CH3_POLARITY_FALLING            (TIM_ENCMCTRL_C3LDCNTSEL_0 | TIM_ENCMCTRL_C3LDCNTSEL_1)
