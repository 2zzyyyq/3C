...
typedef struct
{
    ...
    uint8_t NVIC_IRQChannelPriority; /* Specifies the priority for the IRQ channel specified in NVIC_IRQChannel. */
...
/** NVIC Priority **/
#define NVIC_PRIORITY_0          ((uint8_t)0x00U)
#define NVIC_PRIORITY_1          ((uint8_t)0x01U)
#define NVIC_PRIORITY_2          ((uint8_t)0x02U)
#define NVIC_PRIORITY_3          ((uint8_t)0x03U)
